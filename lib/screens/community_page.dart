  ...
  final Map<String, List<CampaignEvent>> categorizedCampaigns = {
    'Upcoming': [
      CampaignEvent(
        ...
        description: 'Join MareCet marine conservation efforts to protect Malaysia marine mammals. Activities include beach cleanups, data collection, and educational outreach. Suitable for all ages and experience levels. Training will be provided.',
        imageUrl: 'assets/images/marecet.jpeg',
        ...
        requirements: 'Bring sunscreen, hat, water bottle, and comfortable clothes. No prior experience needed.',
        capacity: 20,
      ...
      CampaignEvent(
        ...
        description: 'Assist zookeepers in preparing food, cleaning enclosures, and creating enrichment activities for the animals. Learn about wildlife conservation while contributing to animal welfare at Malaysia national zoo.',
        ...
        requirements: 'Age 18+, closed-toe shoes, comfortable clothes. Basic training provided on site.',
        capacity: 30,
      ...
      CampaignEvent(
        ...
        description: 'Free and low-cost vaccinations for dogs and cats from low-income households. Rabies, distemper, and parvovirus vaccines available. Registration required with proof of income and pet ownership.',
        imageUrl: 'assets/images/spca_vax.jpeg',
        ...
        petTypes: ['Dogs', 'Cats'],
        requirements: 'Bring pet in carrier or on leash, vaccination records if available',
        capacity: 100,
      ...
      CampaignEvent(
        ...
        description: 'Learn essential first aid skills for pets including wound care, CPR, heat stroke management, and how to recognize emergency situations. Hands-on practice with mannequins provided.',
        imageUrl: 'assets/iamges/pet_first_aid.jpg',
      ...
      CampaignEvent(
        ...
        description: 'Virtual seminar on understanding and managing common behavioral issues in pets. Topics include separation anxiety, aggression, house soiling, and positive reinforcement training methods.',
        imageUrl: 'assets/images/behavior_seminar.jpeg',
    ...
    'Seasonal': [
      CampaignEvent(
        ...
        description: 'Annual holiday donation drive collecting food, bedding, toys, and medical supplies for rescued animals. Volunteer opportunities include sorting donations, shelter maintenance, and animal socialization. Special adoption promotions available throughout the event.',
        ...
        requirements: 'Donations welcome: pet food, toys, bedding, cleaning supplies',
        capacity: 50,
        currentParticipants: 12,
        isVirtual: false,
      ),
      CampaignEvent(
        ...
        description: 'Educational campaign on keeping pets safe during Hari Raya celebrations. Topics include food hazards, managing anxiety from fireworks and visitors, and proper identification in case pets escape during festivities.',
        imageUrl: 'assets/iamges/raya_pets.jpeg',
      ...
      CampaignEvent(
        ...
        description: 'Training workshop on preparing for pet emergencies during Malaysia\'s monsoon season. Learn about evacuation planning, emergency kits, temporary housing options, and coordination with relief agencies.',
    ...
    'Past': [
      CampaignEvent(
        ...
        description: 'A nationwide celebration featuring educational booths, adoption drives, pet health checkups, and family-friendly activities. The event raised awareness about animal welfare issues and promoted responsible pet ownership across Malaysia.',
      ...
      CampaignEvent(
        ...
        description: 'Intensive workshop on humane management of community cat populations. Participants learned trapping techniques, working with veterinarians, recovery care, and community engagement strategies.',
      ...
      CampaignEvent(
        ...
        description: 'Professional photographers taught pet owners techniques for capturing beautiful portraits of their furry companions. Topics included lighting, composition, working with treats, action shots, and basic photo editing.',
        imageUrl: 'assets/images/pet_photography.jpeg',
        date: 'March 5, 2025',
          ...
          Padding(
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: ['Upcoming', 'Seasonal', 'Past'].map((category) {
                  return Padding(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('This feature will allow community members to create and submit their own events for approval.'),
          actions: [
            TextButton(
              child: Text('Cancel'),
              onPressed: () {
...
class CampaignEvent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isPast = id.startsWith('ev9') || id.startsWith('ev10') || id.startsWith('ev11');
                        ...
                        children: [
                          ...
                          LinearProgressIndicator(
                            ...
                            valueColor: AlwaysStoppedAnimation<Color>(
                              currentParticipants >= capacity ? Colors.red : Colors.teal,
                            ),
                          ),
                        ],
                      ),
...
class _CampaignDetailPageState extends State<CampaignDetailPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final isPast = widget.id.startsWith('ev9') || widget.id.startsWith('ev10') || widget.id.startsWith('ev11');
    final isFull = widget.capacity > 0 && widget.currentParticipants >= widget.capacity;
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(_isSaved ? 'Event saved' : 'Event removed from saved'),
                ...
                children: [
                  ...
                  if (widget.capacity > 0)
                    Container(
                        ...
                        children: [
                          ...
                          LinearProgressIndicator(
                            value: widget.currentParticipants / widget.capacity,
                              backgroundColor: Colors.grey[200],
                              valueColor: AlwaysStoppedAnimation<Color>(
                                widget.currentParticipants >= widget.capacity ? Colors.red : Colors.teal,
                              ),
                            ),
                            SizedBox(height: 8),
                            Text(
                      ...
                      Divider(height: 32),
    _buildInfoSection('Date & Time', Icons.calendar_today, widget.date),
    _buildInfoSection('Location', Icons.location_on, widget.location),
    _buildInfoSection('Contact', Icons.contact_phone, widget.contact),
    _buildInfoSection('Requirements', Icons.assignment, widget.requirements),
    SizedBox(height: 16),
    Text(
      'About This Event',
        ...
        children: [
          Expanded(
            child: ElevatedButton(
              onPressed: canRegister
                  ...
                  : null,
              child: Text(_isRegistered ? 'Cancel Registration' : 'Register Now'),
          ...
          OutlinedButton(
            ...
            child: Icon(
              ...
              color: _isReminded ? Colors.teal : Colors.grey,
            ),
      ...
      child: ListView(
        ...
        children: [
          _buildSimilarEventCard(
            ...
            'assets/images/wildlife_workshop.jpeg',
            'May 5, 2025',
          ),
          _buildSimilarEventCard(
            'Stray Animal Feeding Program',
            'assets/images/stray_feeding.jpeg',
            'April 12, 2025',
          ),
          _buildSimilarEventCard(
            'Pet Adoption Day',
            'assets/images/adoption_day.jpeg',
            'April 18, 2025',
          ),
        ],
      ),
